...
const variantStyles = {
  ...
  secondary:
    'rounded-full bg-red-800 py-2 px-4 text-sm font-medium text-white hover:bg-red-700 focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white/50 active:text-red-400',
}
