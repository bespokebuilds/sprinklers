...
export function MobileNavigation({ activeTab, onTabChange }) {
  ...
  return (
    <>
      ...
      >
        <MenuIcon className="h-6 w-6 stroke-red-500" />
      </button>
      ...
      <Dialog
        open={isOpen}
        onClose={() => close()}
        className="fixed inset-0 z-50 flex items-start overflow-y-auto bg-red-950/50 pr-10 backdrop-blur lg:hidden"
        aria-label="Navigation"
      >
        <Dialog.Panel className="min-h-full w-full max-w-xs bg-white px-4 pb-12 pt-5 dark:bg-red-950 sm:px-6">
          <div className="flex items-center">
            ...
            >
              <CloseIcon className="h-6 w-6 stroke-red-500" />
            </button>
